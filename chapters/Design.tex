...
The first reason being the purpose of the language is calculation operations on the \acrshort{cpu}, we therefor deem this to be a language for smaller applications and thereby the memory is less likely to be filled.
