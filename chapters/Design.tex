...
A complete list of all available standard functions can be seen on \myref{tbl:fucs} together with a desperation of each function.
...
\todo[inline]{Lav table/listing med special functions/stdlib?} 
