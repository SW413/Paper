...
\subsection*{Operators}\todo{nævn at vi er influenced af Matlab bl.a. ved matrix operatorer.}
...
In order to allow users of \gls{gamble} to use data dynamically and save the result, there are a built in \texttt{matrixToFile}--function and a \texttt{fileToMatrix}--function. 
...
A complete list of all available standard functions can be seen on \myref{tbl:funcs} together with a desperation of each function.
