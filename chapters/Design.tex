...
The syntax for the latter does not adhere to the concept of orthogonality mentioned in \myref{chap:criteria} although the use of this syntax should be held to a minimum, as it primarily exists such that functions in the standard library for \gls{gamble} can be created.
...
Since the elements in vectors and matrices are one of the simple types of \gls{gamble}, the vectors and matrices on both sides of an infix operators must adhere to the rules of type compatibility.
