...
The validity of such reference is specific to the rules of the languange, this section describes how the compiler upholds the rules listen in \myref{subsec:Scope}.
