...
First an example of how a \texttt{DeclarationNode} is translated into C code will be given and afterwards the implementation of using the \acrshort{gpu} using OpenCL will be presented.
