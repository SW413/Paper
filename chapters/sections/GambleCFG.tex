...
The full \acrshort{cfg} of \gls{gamble} can be found on \todo{ref til appendix} alongside  the lexer. This section only presents a small selection of the entire \acrshort{cfg}.
