...
The focus for \gls{gamble} is to use the computational powers\todo{skal dette ikke være uden s? MP slet og ret gerne hvis korrekt} of the \acrshort{gpu} to handle such computations without it being inconvenient for the programmer.
