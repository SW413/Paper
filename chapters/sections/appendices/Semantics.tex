...
\begin{equation}
	\frac { { e }_{ v },st\vdash j{ \rightarrow  }_{ A }{ v }_{ 1 },\quad { e }_{ v },st\vdash k{ \rightarrow  }_{ A }{ v }_{ 2 } }{ { M }^{ 1 }\quad =\quad matrix<int|float>[{ v }_{ 1 },{ v }_{ 2 }]\rightarrow { st }^{ ` },{ e }_{ v } } ,{ M }^{ 1 }[{ v }_{ 1 },{ v }_{ 2 }]=\begin{bmatrix} { { 0 }_{ 1,1 } }& 0_{1,2} & \dots  & { 0 }_{ { 1,{ v }_{ 2 } } } \\ 0_{2,1} & 0_{2,2} & \dots  & 0_{2,v_{2}}  \\ \vdots & \vdots & \ddots & \vdots \\ { 0 }_{ { v }_{ 1 },1 } & 0_{v_1,2} & \dots & { 0 }_{ { v }_{ 1 },{ v }_{ 2 } } \end{bmatrix}
\end{equation}
...
\todo{ Skal vi ikke skrive noget inde ` <> ? f.eks. skrive type  eller noget ? bare for at vise at det ikke er tomt ?}