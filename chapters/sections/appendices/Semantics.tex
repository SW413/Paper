...
\begin{equation}
	\frac { { e }_{ v }\vdash { <F }_{ d },{ e }_{ f }[ID\rightarrow S]{ >\rightarrow  }_{ Fd }e_{ p }^{ ` } }{ { e }_{ v }\vdash <{ functiondatatype\quad ID(parameterlist)\quad functionbody;\quad { F }_{ D },{ e }_{ f }>\rightarrow  }_{ Fd }e_{ p }^{ ` } } 
\end{equation}
