...
\subsubsection{Transitions rules for function declaration}
\begin{equation}
	\frac { { e }_{ v }\vdash { <F }_{ d },{ e }_{ p }[ID\rightarrow S]{ >\rightarrow  }_{ Fd }e_{ p }^{ i } }{ { e }_{ v }\vdash <{ functiondatatype\quad ID(parameterlist)\quad functionbody;\quad { F }_{ D },{ e }_{ p }>\rightarrow  }_{ Fd }e_{ p }^{ i } } 
\end{equation}

\subsubsection{Function Declaration}
\begin{equation}
\frac { { e }_{ v }\vdash <S,st>\rightarrow { st }^{ i } }{ { e }_{ v }\vdash <call\quad ID(argumentlist),st>\rightarrow { st }^{ i } }
\end{equation}
