...
\begin{equation}
	\frac { { e }_{ v },st\vdash { vec }_{ 1 }{ \rightarrow  }_{ A }{ v }_{ 1 }\quad { e }_{ v },st\vdash { a }_{ 1 }{ \rightarrow  }_{ A }{ v }_{ 2 } }{ { e }_{ v },st\vdash { vec }_{ 1 }\ast { a }_{ 1 }{ \rightarrow  }_{ A }{ v } } ,\begin{matrix} { v }_{ 1 }=vector<>[{ m }^{ 1 }] \\ { v }_{ 2 }={ a }_{ 1 } \\ v=\begin{bmatrix} { { a }_{ 1 }*m }_{ 1 }^{ 1 } \\ \vdots  \\ { { a }_{ 1 }*m }_{ n }^{ 1 } \end{bmatrix} \end{matrix}
\end{equation}