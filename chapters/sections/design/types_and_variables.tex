...
The use of operators between matrix and vector instances is influenced by matlab which uses the same concept with great success.\todo{``with great success`` Er det bare vores mening? - Corlin}
