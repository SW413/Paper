...
This is enabled such that the programmer can use this feature to write out messages to the console.\todo{This is enabled to let programmers write messages to the console. måske? MP}
