§ubsubsection*{Using SimpleOpenCl}
...
Before this code is appended any string with a \S is is replaced with the corresponding string depending on the situation.
...
\begin{lstlisting}[caption=Kernel code for multiplying a matrix or vector with a scalar.,numbers=none,frame=tlrb,label={lst:replaceString}]
