...
This allows the ability of adding new operations without changing the original data structure, and also without changing other visitors, which serves well when using a iterative development method.\todo{gører sidste del til selvstændig sætning? MP}
...
\vspace{-15pt}
\end{figure}
\todo[inline]{har vi selv lavet figuren? MP}
