...
As can be seen on \myref{image:visitor} ``ConcreteVisitorA'' and ``ConcreteVisitorB'', both implements a visit method for the ``ConcreteElements'' A and B.
