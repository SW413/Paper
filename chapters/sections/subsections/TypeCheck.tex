...
The symbol table is used as a reference for which type the variable is, and therefore the type checking happens after the symbol table have been filled, hence after scope checking is completed. 
...
This check is done as a part of decorating the AST and uses a visitor to traverse the AST. \todo{implementering? ...(ja -sass)}