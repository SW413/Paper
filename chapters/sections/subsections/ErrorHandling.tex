...
This includes line numbers which then have to be carried over from the parse tree to the abstract syntax tree, this is expanded in \todo{ref til afsnit som ikke findes i denne branch}.
