Error handling is a descriptive section of how the \gls{gamble} handle errors, and how error handling is implemented.
...
This include line numbers which then have to be carried over from the parse tree to the abstract syntax tree, this is expanded in \myref{sec:AST}.
