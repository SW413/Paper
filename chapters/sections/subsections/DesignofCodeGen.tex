...
The visitor builds a string\todo{of object code -- Troels} by traversing the nodes of the tree which will in the end be put into a file by the \texttt{CodeGenerator} class.
