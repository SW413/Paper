...
From the elements if, goto and label the other constructs above can be made.\todo{label er ikke med på listen, skal det være under goto? - Søren}
...
The syntax is identical to the if statement, which also makes it look like a function and explicitly express the scope.
