...
A typical compilation on Ubuntu 14.04 configured with OpenCL headers located at \texttt{/opt/opencl-headers/include/} will look like \myref{lst:makecommands}, where \texttt{code.c} is the output of the \gls{gamble} compiler.
