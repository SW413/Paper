...
Two common ways of implementing a symbol table is as follows; either you have one table which contains every identifier or you have a symbol table for each scope. \todo{skrives om unden you. MP}
