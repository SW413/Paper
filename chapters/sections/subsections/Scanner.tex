\subsection*{Scanner}
The first stage of syntax analysis is the lexical analysis, which is often done in something called a scanner but can also be called the lexer.\todo{..done in a scanner, allo sometimes referred to as a lexer. MP}
...
LINE_COMMENT
    ...
    ;
\end{lstlisting} 
\todo[inline]{Vi burde holde os til et begreb, lexer eller scanner. MP}