...
The scanner syntax is usually a regular language, whose alphabet consists of the individual characters of the source code.%I dont get this?
...
Some examples of our lexical rules for GAMBLE can be seen on \myref{lst:token}.
