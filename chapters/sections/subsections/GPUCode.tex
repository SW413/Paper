...
This is not always the best choice, as \myref{sec:comparch} shows, but it does make the code generation less complicated.
A more in depth consideration of what vector and matrix computations should be performed on the GPU, would be a way of improving the execution time of the languange.
