...
Where previous versions of \acrshort{antlr} have also implemented the AST, it is not contained in \acrshort{antlr} v4, instead the parse tree provided by \acrshort{antlr} has been used to generate an AST this is discussed in \myref{sec:AST}.
