...
Two common ways of traversing the parse-tree are the visitor pattern and the listener pattern. 
...
We have chosen to use the visitor pattern to gain controls over the traverse of the parse-tree, the pattern and how it is implemented is described further in \myref{subs:visit}. 
