...
The composite pattern is a structural pattern where the visitor pattern is a behavioral one.
...
A behavioral pattern is instead used to define how the objects communicate, the visitor pattern is used to separate a set of structured classes from any functionality that should be performed upon them.
