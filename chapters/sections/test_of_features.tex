...
In \myref{lst:scope1} a variable is declared in an inner scope, used there and used in an enclosing scope on line 6.
...
When used as input in the \gls{gamble} compiler, \myref{lst:scope1} produces the following output: \texttt{Error[line    6]-> Undeclared variable a in scope Local} \todo{Det eneste jeg synes er at vi har mange refs i alt det over}
