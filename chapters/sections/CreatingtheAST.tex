...
Now that the Syntax analysis phase is done it is time for the contextual analysis phase which the next chapter will cover. \todo{Denne sætning virker lidt ``out of place'' imo. -- Troels}
