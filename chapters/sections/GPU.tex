...
In addition to the threshold, the result also confirms that as the dataset grows the \acrshort{gpu} becomes exponentially faster at computing the data. \todo{Er dette forhold exponentiel eller liniært? -- TK}
