\chapter{Semantics}\todo{Der skal eventuelt skrives noget omkring hvad det semantic der er sat ind repræsentere og hvordan det foregår? - Marc}
...
The semantics are organised as follow:
...
A statement should not modify the variable environment.\todo{why? - Marc}
