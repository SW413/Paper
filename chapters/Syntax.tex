...
\caption{A venndiagram showing the similarities between the different subclasses of CFGs.}. \citep{NvidiaCUDASeminar} \todo[inline]{TODO: Tikz figur med LL(*) indsat.}}\label{image:hierarchyofgrammars}
\vspace{-15pt}
\end{figure}
