...
One of these tools, \acrshort{antlr}, will be discussed later in \myref{sec:ANTLR}.\todo{Er det vigtigt at nævne Antlr her ? - Søren}
...
This Venn diagram is shown in \myref{fig:hierarchyofgrammars}\todo{compiler til section istedet for figure hos mig - morten}, LL(*) can express the same grammars as LL(k).
