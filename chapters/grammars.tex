...
\subsection{The dangling else problem}\todo{Thomas spørger om det er vigtigt for os.}
...
An LL parser is calleed an LL(*) parser if it is not limited to finite tokens of lookahead, but can make parsing decisions by recognizing whether the following tokens belong to a regular language.
