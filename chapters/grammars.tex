...
\todo{Er lidt i tvivl om hvorvidt dette giver precedense? Da +'et er på et nonterminal som er højere oppe, da et term også er en expression, som er her hvor plusset er?'}
...
\todo{skriv om de transformationer man kan lave for at omgå ambiguous grammar. Har nu skrevet om dangling else nedenfor.}
...
\end{lstlisting}\todo{Loop header, giver det ikke lidt forvirring og blande det ind i det her også ?}
...
\todo{Hvad menes med powerful her?}
\begin{figure}[!ht]
\centering
