...
We define a BS-semantic for statements (except procedure calls) \todo{Jeg er mega forvirret over opdelingen her ? Hører assignment under Statements her ? Eller hvad sker der ? Når man kigger i rapporten er jeg lidt forvirret.}
...
Declaring a matrix of a given type is generated with the size of $v_{1}*v_{2}$. \todo{Hvorfor * ??}
