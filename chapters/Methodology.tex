...
There is no customer for whom the project is being developed nor is there really time for one person in the group to be Scrum master, as he would still need to focus a lot on the tasks the rest of the group are also partaking in.\todo{Man har vel tid til det ? Har man ikke ?}
...
The project has a hard deadline to take into account, which forces the project to have a certain number of sprints, instead of being able to develop on the project eternally.
