...
Robert W. Sebesta has given some criteria which can be evaluated from, these will be used these criteria to design the language and to state which criteria are important to the language.\citep{Sebesta}
...
We deem our language and compiler to be a good solution for our problem statement if it upholds to the following criteria:\todo{Igen compiler? - Søren}
