...
Previously handwritten C code for the \acrshort{cpu} has been compared to handwritten CUDA C code running on the \acrshort{gpu}, see \myref{subsec:gpuvscpuv1}.
