...
A case for choosing the compiler would be that since the language is expecting to be used for large calculations with a long runtime; and compiled code often executes faster.\todo{Kilde på compiled kode.}
