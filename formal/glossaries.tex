...
\newglossaryentry{Parallel Thread Execution}{name=PTX, description={Pseudo-assembly languange used by Nvidia and \gls{opencl} as the target languange when compiling kernals}}
