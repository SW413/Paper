...
Every language and library described in this section is to be found on \ref{tbl:sota} for easy comparing.
...
The abstraction vary much between the different libraries. \todo{Mangler kilde på dette - snak med Morten}
