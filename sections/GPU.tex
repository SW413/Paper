...
\begin{figure}[h!]
\centering
 \includegraphics[trim=1.4cm 6.1cm 6.5cm 1.8cm, clip, width=1\textwidth]{figures/GPUCPUimage.PNG} % trim=4.85cm 15cm 0.85cm 1cm
...
\begin{figure}[h!]
\centering
 \includegraphics[trim=1.4cm 6.1cm 6.5cm 1.8cm, clip, width=1\textwidth]{figures/SM.PNG} % trim=4.85cm 15cm 0.85cm 1cm
