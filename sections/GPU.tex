...
The GPU consists of more less powerful cores where as the CPU consists of fewer more powerful ones, the greater amount of cores allows for more computation power for simpler problems, where as more complex problems can prove difficult. \todo{Expand on this(Interesting)} 
