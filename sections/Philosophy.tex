...
This is gained through using a familiar syntax, as meniton above, aswell as sticking to certain languange characteristis shown in \myref{tbl:concepts}.
...
\hline
\begin{tabular}[c]{@{}l@{}}Languange\\ Concepts\end{tabular} & Readability            & \multicolumn{1}{l|}{Writeability} & \multicolumn{1}{l|}{Reliability} \\ \hline
Simplicity                                                   & \multicolumn{1}{c|}{x} & x                                 & x                                \\ \hline
Othogonality                                                 & \multicolumn{1}{c|}{x} & x                                 & x                                \\ \hline
...
Execption handling                                           &                        & \multicolumn{1}{l|}{}             & x                                \\ \hline
Retricted aliasing                                           &                        & \multicolumn{1}{l|}{}             & x                                \\ \hline
\caption{Languange evaluation criteria and the characteristics that affect them.\citep{Sebesta}}
	\label{tbl:concepts}
\end{tabular}
\end{table}