...
It makes sense for GAMBLE to stick with a C-like syntax, as several of the most popular languages also uses a C-like syntax, the difference will be in how code is structured.\citep{TIOBE}
\begin{table}[h]
