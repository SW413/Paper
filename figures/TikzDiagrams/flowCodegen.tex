...
\end{figure}\todo{Der skal et slut stadie på fra Output Code, hvad sker der så ? Slutter det hele bliver det compileret automatisk ? Der skal være en pil til something. Derudover er Code generation visitor vel ikke rigtig en fase som sådan, er det ikke bare code generation - Søren}
\vspace{-20pt}